Book My Show:
------------
1)Should be able to list all the cinema halls where the movie is played.
2)Each cimea can have multiple auditorium and reach auditorium can play a show at a time.
3)Each movie will have a multiple show.
4)Customers should be able to search based on movie name, genere, music language ,release date and city name.
5)Once a customer selects a movie ,the service should show the cinema running the movie and its shows.
6)The customer should be able to book the  ticket at a particular cinema hall.
7)Service should allow user to select the seating arrangemnet.
8)Customer should be able to distinguish between booked and available seats.
9)Payment 
10)Notifications
