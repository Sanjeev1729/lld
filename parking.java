Parking Lot Design:
------------------
1)There should be multiple floor.
2)There should be multiple spots.
3)There shuould be multiple gates.
4)At each gate there will be a attendant.
6)Issue the ticket at entry and process payment at exit.
7)Support different type of vechile.
8)Support different type of payment method.
